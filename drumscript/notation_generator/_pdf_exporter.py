...
#     ... [Redacted for brevity, keeping your exact previous comments intact in spirit] ...
...
# --- NEW LARGER NOTEHEAD FUNCTION WITH ACCENT SUPPORT AND CLEANER LINES ---
...
def export_pdf(detected_events, output_filepath, tempo, time_signature="4/4"):
    ...
    for m in range(last_measure_idx + 1):
        ...
        # --- OLD: DRAW MEASURE NUMBERS (Italics and Offset) ---
