...
from drumscript.notation_generator.constants import ONSET_SLICE_DURATION_MS, HOP_LENGTH, KICK_FREQ_MIN, KICK_FREQ_MAX, KICK_LFER_MIN
...
def classify_events(audio_data, sr, onsets) -> List[Dict[str, Any]]:
    ...
    for onset_time in onsets:
        ...
        #             "analysis": physics_profile, # Feed the physics data to the JSON output
        #         }
        #     )
